...
const DealMatrixVercel = () => {
  ...
  const criteria: Record<string, { id: string; label: string; desc: string }[]> = useMemo(() => ({
    'Sponsor Quality & Track Record': [
      ...
      { id: 'sponsorCredibility', label: 'Credibility & Presence',      desc: '5: Known in market | 4: Active in industry | 3: Clean background | 2: Limited footprint | 1: Concerning gaps' },
    ...
    'Business Model & Competitive Position': [
      ...
      { id: 'managementTenure',       label: 'Management Tenure',        desc: '5: CEO/CFO 5+ yrs staying | 4: 3-5 yrs staying | 3: 2-3 yrs | 2: <2 yrs | 1: Complete turnover' },
    ...
    'Financial Performance & Metrics': [
      ...
      { id: 'revenueGrowth',  label: 'Revenue CAGR (3y)',  desc: '5: >25% | 4: 15-25% | 3: 10-15% | 2: 5-10% | 1: <5%' },
      { id: 'ebitdaGrowth',   label: 'EBITDA CAGR (3y)',   desc: '5: >30% | 4: 20-30% | 3: 15-20% | 2: 10-15% | 1: <10%' },
    ...
    'Deal Economics & Structure': [
      ...
      { id: 'dealRollover',     label: 'Seller Rollover',    desc: '5: ≥30% | 4: 20-29% | 3: 10-19% | 2: 5-9% | 1: <5%' },
    ],
